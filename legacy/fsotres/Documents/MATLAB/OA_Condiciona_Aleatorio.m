function varargout = OA_Condiciona_Aleatorio(varargin)
% OA_CONDICIONA_ALEATORIO MATLAB code for OA_Condiciona_Aleatorio.fig
%      OA_CONDICIONA_ALEATORIO, by itself, creates a new OA_CONDICIONA_ALEATORIO or raises the existing
%      singleton*.
%
%      H = OA_CONDICIONA_ALEATORIO returns the handle to a new OA_CONDICIONA_ALEATORIO or the handle to
%      the existing singleton*.
%
%      OA_CONDICIONA_ALEATORIO('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in OA_CONDICIONA_ALEATORIO.M with the given input arguments.
%
%      OA_CONDICIONA_ALEATORIO('Property','Value',...) creates a new OA_CONDICIONA_ALEATORIO or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before OA_Condiciona_Aleatorio_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to OA_Condiciona_Aleatorio_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help OA_Condiciona_Aleatorio

% Last Modified by GUIDE v2.5 04-Jul-2014 15:36:40

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @OA_Condiciona_Aleatorio_OpeningFcn, ...
                   'gui_OutputFcn',  @OA_Condiciona_Aleatorio_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before OA_Condiciona_Aleatorio is made visible.
function OA_Condiciona_Aleatorio_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to OA_Condiciona_Aleatorio (see VARARGIN)

% Choose default command line output for OA_Condiciona_Aleatorio
...
% UIWAIT makes OA_Condiciona_Aleatorio wait for user response (see UIRESUME)
...
function varargout = OA_Condiciona_Aleatorio_OutputFcn(hObject, eventdata, handles) 
