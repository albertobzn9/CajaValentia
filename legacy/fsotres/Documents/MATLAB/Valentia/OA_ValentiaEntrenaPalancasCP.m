function varargout = OA_ValentiaEntrenaPalancasCP(varargin)
% OA_VALENTIAENTRENAPALANCASCP M-file for OA_ValentiaEntrenaPalancasCP.fig
%      OA_VALENTIAENTRENAPALANCASCP, by itself, creates a new OA_VALENTIAENTRENAPALANCASCP or raises the existing
%      singleton*.
%
%      H = OA_VALENTIAENTRENAPALANCASCP returns the handle to a new OA_VALENTIAENTRENAPALANCASCP or the handle to
%      the existing singleton*.
%
%      OA_VALENTIAENTRENAPALANCASCP('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in OA_VALENTIAENTRENAPALANCASCP.M with the given input arguments.
%
%      OA_VALENTIAENTRENAPALANCASCP('Property','Value',...) creates a new OA_VALENTIAENTRENAPALANCASCP or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before OA_ValentiaEntrenaPalancasCP_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to OA_ValentiaEntrenaPalancasCP_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help OA_ValentiaEntrenaPalancasCP

% Last Modified by GUIDE v2.5 21-Feb-2014 17:56:05

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @OA_ValentiaEntrenaPalancasCP_OpeningFcn, ...
                   'gui_OutputFcn',  @OA_ValentiaEntrenaPalancasCP_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before OA_ValentiaEntrenaPalancasCP is made visible.
function OA_ValentiaEntrenaPalancasCP_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to OA_ValentiaEntrenaPalancasCP (see VARARGIN)

% Choose default command line output for OA_ValentiaEntrenaPalancasCP
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes OA_ValentiaEntrenaPalancasCP wait for user response (see UIRESUME)
...
function varargout = OA_ValentiaEntrenaPalancasCP_OutputFcn(hObject, eventdata, handles) 
