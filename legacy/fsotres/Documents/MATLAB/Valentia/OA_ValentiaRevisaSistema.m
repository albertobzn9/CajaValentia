function varargout = OA_ValentiaRevisaSistema(varargin)
% OA_VALENTIAREVISASISTEMA M-file for OA_ValentiaRevisaSistema.fig
%      OA_VALENTIAREVISASISTEMA, by itself, creates a new OA_VALENTIAREVISASISTEMA or raises the existing
%      singleton*.
%
%      H = OA_VALENTIAREVISASISTEMA returns the handle to a new OA_VALENTIAREVISASISTEMA or the handle to
%      the existing singleton*.
%
%      OA_VALENTIAREVISASISTEMA('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in OA_VALENTIAREVISASISTEMA.M with the given input arguments.
%
%      OA_VALENTIAREVISASISTEMA('Property','Value',...) creates a new OA_VALENTIAREVISASISTEMA or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before OA_ValentiaRevisaSistema_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to OA_ValentiaRevisaSistema_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help OA_ValentiaRevisaSistema

% Last Modified by GUIDE v2.5 04-Mar-2013 17:02:23

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @OA_ValentiaRevisaSistema_OpeningFcn, ...
                   'gui_OutputFcn',  @OA_ValentiaRevisaSistema_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before OA_ValentiaRevisaSistema is made visible.
function OA_ValentiaRevisaSistema_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to OA_ValentiaRevisaSistema (see VARARGIN)

% Choose default command line output for OA_ValentiaRevisaSistema
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes OA_ValentiaRevisaSistema wait for user response (see UIRESUME)
...
function varargout = OA_ValentiaRevisaSistema_OutputFcn(hObject, eventdata, handles) 
...
EstEle=get(handles.checkbox9,'Value');
OA_ValentiaElectrico(handles.OA,EstEle);
