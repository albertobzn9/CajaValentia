function varargout = OA_Condicionamiento(varargin)
% OA_CONDICIONAMIENTO MATLAB code for OA_Condicionamiento.fig
%      OA_CONDICIONAMIENTO, by itself, creates a new OA_CONDICIONAMIENTO or raises the existing
%      singleton*.
%
%      H = OA_CONDICIONAMIENTO returns the handle to a new OA_CONDICIONAMIENTO or the handle to
%      the existing singleton*.
%
%      OA_CONDICIONAMIENTO('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in OA_CONDICIONAMIENTO.M with the given input arguments.
%
%      OA_CONDICIONAMIENTO('Property','Value',...) creates a new OA_CONDICIONAMIENTO or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before OA_Condicionamiento_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to OA_Condicionamiento_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help OA_Condicionamiento

% Last Modified by GUIDE v2.5 19-Aug-2013 18:32:05

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @OA_Condicionamiento_OpeningFcn, ...
                   'gui_OutputFcn',  @OA_Condicionamiento_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before OA_Condicionamiento is made visible.
function OA_Condicionamiento_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to OA_Condicionamiento (see VARARGIN)

% Choose default command line output for OA_Condicionamiento
...
% UIWAIT makes OA_Condicionamiento wait for user response (see UIRESUME)
...
function varargout = OA_Condicionamiento_OutputFcn(hObject, eventdata, handles) 
...
% codigo para prender en forma intermitente o solo sonido intermitente
...
%    end  
   ...
   %prendemos ambas luces en forma continua
   if(get(handles.checkbox1,'Value')==1)
