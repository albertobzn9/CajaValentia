function varargout = OA_ValentiaCuatroB(varargin)
% OA_VALENTIACUATROB MATLAB code for OA_ValentiaCuatroB.fig
%      OA_VALENTIACUATROB, by itself, creates a new OA_VALENTIACUATROB or raises the existing
%      singleton*.
%
%      H = OA_VALENTIACUATROB returns the handle to a new OA_VALENTIACUATROB or the handle to
%      the existing singleton*.
%
%      OA_VALENTIACUATROB('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in OA_VALENTIACUATROB.M with the given input arguments.
%
%      OA_VALENTIACUATROB('Property','Value',...) creates a new OA_VALENTIACUATROB or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before OA_ValentiaCuatroB_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to OA_ValentiaCuatroB_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help OA_ValentiaCuatroB

% Last Modified by GUIDE v2.5 26-Aug-2013 15:52:28

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @OA_ValentiaCuatroB_OpeningFcn, ...
                   'gui_OutputFcn',  @OA_ValentiaCuatroB_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before OA_ValentiaCuatroB is made visible.
function OA_ValentiaCuatroB_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to OA_ValentiaCuatroB (see VARARGIN)

% Choose default command line output for OA_ValentiaCuatroB
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes OA_ValentiaCuatroB wait for user response (see UIRESUME)
...
function varargout = OA_ValentiaCuatroB_OutputFcn(hObject, eventdata, handles) 
