function varargout = OA_ValentiaCuatroC(varargin)
% OA_VALENTIACUATROC MATLAB code for OA_ValentiaCuatroC.fig
%      OA_VALENTIACUATROC, by itself, creates a new OA_VALENTIACUATROC or raises the existing
%      singleton*.
%
%      H = OA_VALENTIACUATROC returns the handle to a new OA_VALENTIACUATROC or the handle to
%      the existing singleton*.
%
%      OA_VALENTIACUATROC('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in OA_VALENTIACUATROC.M with the given input arguments.
%
%      OA_VALENTIACUATROC('Property','Value',...) creates a new OA_VALENTIACUATROC or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before OA_ValentiaCuatroC_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to OA_ValentiaCuatroC_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help OA_ValentiaCuatroC

% Last Modified by GUIDE v2.5 20-Sep-2013 14:53:49

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @OA_ValentiaCuatroC_OpeningFcn, ...
    'gui_OutputFcn',  @OA_ValentiaCuatroC_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before OA_ValentiaCuatroC is made visible.
function OA_ValentiaCuatroC_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to OA_ValentiaCuatroC (see VARARGIN)

% Choose default command line output for OA_ValentiaCuatroC
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes OA_ValentiaCuatroC wait for user response (see UIRESUME)
...
function varargout = OA_ValentiaCuatroC_OutputFcn(hObject, eventdata, handles)
