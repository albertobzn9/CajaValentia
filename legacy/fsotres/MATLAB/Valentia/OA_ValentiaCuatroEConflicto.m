...
% Last Modified by GUIDE v2.5 07-Apr-2017 16:40:02
...
set(handles.edit4,'String','31'); %ensayos a realizar
...
%             end
        ...
        if((Secuencia(Ensayo,2)==1)|(Secuencia(Ensayo,2)==3)) %ensayo con riesgo o conflicto
            ...
            if(get(handles.checkbox7,'Value')==1)
                if(Secuencia(Ensayo,2)==1) %si no es conflicto
