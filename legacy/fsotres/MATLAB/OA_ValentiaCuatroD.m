function varargout = OA_ValentiaCuatroD(varargin)
% OA_VALENTIACUATROD MATLAB code for OA_ValentiaCuatroD.fig
%      OA_VALENTIACUATROD, by itself, creates a new OA_VALENTIACUATROD or raises the existing
%      singleton*.
%
%      H = OA_VALENTIACUATROD returns the handle to a new OA_VALENTIACUATROD or the handle to
%      the existing singleton*.
%
%      OA_VALENTIACUATROD('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in OA_VALENTIACUATROD.M with the given input arguments.
%
%      OA_VALENTIACUATROD('Property','Value',...) creates a new OA_VALENTIACUATROD or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before OA_ValentiaCuatroD_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to OA_ValentiaCuatroD_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help OA_ValentiaCuatroD

% Last Modified by GUIDE v2.5 02-Oct-2013 19:26:39

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @OA_ValentiaCuatroD_OpeningFcn, ...
    'gui_OutputFcn',  @OA_ValentiaCuatroD_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before OA_ValentiaCuatroD is made visible.
function OA_ValentiaCuatroD_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to OA_ValentiaCuatroD (see VARARGIN)

% Choose default command line output for OA_ValentiaCuatroD
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes OA_ValentiaCuatroD wait for user response (see UIRESUME)
...
function varargout = OA_ValentiaCuatroD_OutputFcn(hObject, eventdata, handles)
