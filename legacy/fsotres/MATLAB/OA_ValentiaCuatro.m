function varargout = OA_ValentiaCuatro(varargin)
% OA_VALENTIACUATRO MATLAB code for OA_ValentiaCuatro.fig
%      OA_VALENTIACUATRO, by itself, creates a new OA_VALENTIACUATRO or raises the existing
%      singleton*.
%
%      H = OA_VALENTIACUATRO returns the handle to a new OA_VALENTIACUATRO or the handle to
%      the existing singleton*.
%
%      OA_VALENTIACUATRO('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in OA_VALENTIACUATRO.M with the given input arguments.
%
%      OA_VALENTIACUATRO('Property','Value',...) creates a new OA_VALENTIACUATRO or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before OA_ValentiaCuatro_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to OA_ValentiaCuatro_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help OA_ValentiaCuatro

% Last Modified by GUIDE v2.5 16-May-2013 16:04:53

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @OA_ValentiaCuatro_OpeningFcn, ...
                   'gui_OutputFcn',  @OA_ValentiaCuatro_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before OA_ValentiaCuatro is made visible.
function OA_ValentiaCuatro_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to OA_ValentiaCuatro (see VARARGIN)

% Choose default command line output for OA_ValentiaCuatro
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes OA_ValentiaCuatro wait for user response (see UIRESUME)
...
function varargout = OA_ValentiaCuatro_OutputFcn(hObject, eventdata, handles) 
