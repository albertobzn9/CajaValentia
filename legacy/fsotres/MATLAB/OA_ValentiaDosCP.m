function varargout = OA_ValentiaDosCP(varargin)
% OA_VALENTIADOSCP MATLAB code for OA_ValentiaDosCP.fig
%      OA_VALENTIADOSCP, by itself, creates a new OA_VALENTIADOSCP or raises the existing
%      singleton*.
%
%      H = OA_VALENTIADOSCP returns the handle to a new OA_VALENTIADOSCP or the handle to
%      the existing singleton*.
%
%      OA_VALENTIADOSCP('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in OA_VALENTIADOSCP.M with the given input arguments.
%
%      OA_VALENTIADOSCP('Property','Value',...) creates a new OA_VALENTIADOSCP or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before OA_ValentiaDosCP_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to OA_ValentiaDosCP_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help OA_ValentiaDosCP

% Last Modified by GUIDE v2.5 07-Mar-2013 10:28:07

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @OA_ValentiaDosCP_OpeningFcn, ...
                   'gui_OutputFcn',  @OA_ValentiaDosCP_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before OA_ValentiaDosCP is made visible.
function OA_ValentiaDosCP_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to OA_ValentiaDosCP (see VARARGIN)

% Choose default command line output for OA_ValentiaDosCP
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes OA_ValentiaDosCP wait for user response (see UIRESUME)
...
function varargout = OA_ValentiaDosCP_OutputFcn(hObject, eventdata, handles) 
