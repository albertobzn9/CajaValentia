function [Fila,ContadorTI,ContadorTD,Detenido,EstadoPalanqueos,EventosPalanqueo] = ...
    OA_EjecutaSonidoSoloCP(handles,LadoObjetivo,Duracion,freqRiesgo,NumeroEvento,R0,ContadorTI,ContadorTD,EstadoPalanqueos,EventosPalanqueo)
...
if nargin >= 10
    [LadoResultado,LatenciaCruce,ContadorTI,ContadorTD,Detenido, ...
        ...
        handles.OA,Duracion,ContadorTI,ContadorTD,handles.edit9, ...
        EstadoPalanqueos,EventosPalanqueo,R0,NumeroEvento);
else
    [LadoResultado,LatenciaCruce,ContadorTI,ContadorTD,Detenido] = ...
